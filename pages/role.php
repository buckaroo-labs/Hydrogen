	...
	if ( isset( $_GET['action'])) {
		...
		if ($_GET['action']=="mappriv") $action="mappriv";
			...
			if ( isset($roleID) and isset($userID)  ) {
				...
				$stmt->execute();
				*/
				$sql="insert into m_user_role (role_id,user_id) values (".$roleID.",".$userID.")";
				$dds->setSQL($sql);
			}
			...
			if ( isset($roleID) and isset($userID)  ) {
				...
				$stmt->execute();
				*/
				$sql="delete from m_user_role where role_id=".$roleID." and user_id=" . $userID;
				$dds->setSQL($sql);
			}
			...
			if ( isset($roleID) and isset($privID)  ) {
				...
				$stmt->execute();
				*/
				$sql="insert into m_role_privilege (role_id,privilege_id) values (".$roleID.",".$privID.")";
				$dds->setSQL($sql);
			}
			...
			if ( isset($roleID) and isset($privID)  ) {
				...
				$stmt->execute();
				*/
				$sql="delete from m_role_privilege where role_id=". $roleID." and privilege_id=" .  $privID;
				$dds->setSQL($sql);
			}
